...
%}        
%{
iris = [ 5.1 3.5 1 ; 4.9 3.0 1 ; 4.7 3.2 1 ;
         4.6 3.1 1 ; 5.0 3.6 1 ; 5.4 3.9 1 ;
         4.6 3.4 1 ; 5.0 3.4 1 ; 4.4 2.9 1 ;
         4.9 3.1 1 ; 5.4 3.7 1 ; 4.8 3.4 1 ;
         4.8 3.0 1 ; 4.3 3.0 1 ; 5.8 4.0 1 ;
         5.7 4.4 1 ; 5.4 3.9 1 ; 5.1 3.5 1 ;
         5.7 3.8 1 ; 5.1 3.8 1 ; 5.4 3.4 1 ;
         5.1 3.7 1 ; 4.6 3.6 1 ; 5.1 3.3 1 ;
         4.8 3.4 1 ; 5.0 3.0 1 ; 5.0 3.4 1 ;
         5.2 3.5 1 ; 5.2 3.4 1 ; 4.7 3.2 1 ;
         4.8 3.1 1 ; 5.4 3.4 1 ; 5.2 4.1 1 ;
         5.5 4.2 1 ; 4.9 3.1 1 ; 5.0 3.2 1 ;
         5.5 3.5 1 ; 4.9 3.1 1 ; 4.4 3.0 1 ;
         5.1 3.4 1 ; 5.0 3.5 1 ; 4.5 2.3 1 ;
         4.4 3.2 1 ; 5.0 3.5 1 ; 5.1 3.8 1 ;
         4.8 3.0 1 ; 5.1 3.8 1 ; 4.6 3.2 1 ;
         5.3 3.7 1 ; 5.0 3.3 1 ; 7.0 3.2 2 ;
         6.4 3.2 2 ; 6.9 3.1 2 ; 5.5 2.3 2 ;
         6.5 2.8 2 ; 5.7 2.8 2 ; 6.3 3.3 2 ;
         4.9 2.4 2 ; 6.6 2.9 2 ; 5.2 2.7 2 ;
         5.0 2.0 2 ; 5.9 3.0 2 ; 6.0 2.2 2 ;
         6.1 2.9 2 ; 5.6 2.9 2 ; 6.7 3.1 2 ;
         5.6 3.0 2 ; 5.8 2.7 2 ; 6.2 2.2 2 ;
         5.6 2.5 2 ; 5.9 3.2 2 ; 6.1 2.8 2 ;
         6.3 2.5 2 ; 6.1 2.8 2 ; 6.4 2.9 2 ;
         6.6 3.0 2 ; 6.8 2.8 2 ; 6.7 3.0 2 ;
         6.0 2.9 2 ; 5.7 2.6 2 ; 5.5 2.4 2 ;
         5.5 2.4 2 ; 5.8 2.7 2 ; 6.0 2.7 2 ;
         5.4 3.0 2 ; 6.0 3.4 2 ; 6.7 3.1 2 ;
         6.3 2.3 2 ; 5.6 3.0 2 ; 5.5 2.5 2 ;
         5.5 2.6 2 ; 6.1 3.0 2 ; 5.8 2.6 2 ;
         5.0 2.3 2 ; 5.6 2.7 2 ; 5.7 3.0 2 ;
         5.7 2.9 2 ; 6.2 2.9 2 ; 5.1 2.5 2 ;
         5.7 2.8 2 ; 6.3 3.3 3 ; 5.8 2.7 3 ;
         7.1 3.0 3 ; 6.3 2.9 3 ; 6.5 3.0 3 ;
         7.6 3.0 3 ; 4.9 2.5 3 ; 7.3 2.9 3 ;
         6.7 2.5 3 ; 7.2 3.6 3 ; 6.5 3.2 3 ;
         6.4 2.7 3 ; 6.8 3.0 3 ; 5.7 2.5 3 ;
         5.8 2.8 3 ; 6.4 3.2 3 ; 6.5 3.0 3 ;
         7.7 3.8 3 ; 7.7 2.6 3 ; 6.0 2.2 3 ;
         6.9 3.2 3 ; 5.6 2.8 3 ; 7.7 2.8 3 ;
         6.3 2.7 3 ; 6.7 3.3 3 ; 7.2 3.2 3 ;
         6.2 2.8 3 ; 6.1 3.0 3 ; 6.4 2.8 3 ;
         7.2 3.0 3 ; 7.4 2.8 3 ; 7.9 3.8 3 ;
         6.4 2.8 3 ; 6.3 2.8 3 ; 6.1 2.6 3 ;
         7.7 3.0 3 ; 6.3 3.4 3 ; 6.4 3.1 3 ;
         6.0 3.0 3 ; 6.9 3.1 3 ; 6.7 3.1 3 ;
         6.9 3.1 3 ; 5.8 2.7 3 ; 6.8 3.2 3 ;
         6.7 3.3 3 ; 6.7 3.0 3 ; 6.3 2.5 3 ;
         6.5 3.0 3 ; 6.2 3.4 3 ; 5.9 3.0 3 ];
...
% transf do dataset por phi(x) = (x1,x1*x2,x1*x2,x2)
[x,idx] = unique(iris(:,1:2), 'rows');
t = iris(idx,3);
X = zeros(n,4);
for i = 1:n
  X(i,:) = [x(i,1) x(i,1)*x(i,2) x(i,1)*x(i,2) x(i,2)];
end
x = X;
n = size(x,1);
%%%%%
%}
%{
x = importdata('data/wine.data',',');
t = x(:,1);
n = size(x,1);
%}
%{
dataset = 'c';
x = importdata('data/cancer.data',',');
x = x(:,2:size(x,2));
t = x(:,10);
n = size(x,1);
%}
...
choice_size = 20;
random_choice = unique( randi(n,1,round(n*choice_size/100)) );
xs = x(random_choice,:);
ty = t(random_choice);
tic
[ys,z] = force(xs,1);
...
clf;
hold on;
plot(ys(ty == 4,1), ys(ty == 4,2), 'ro', 'MarkerSize', 15);
...
plot(ys(ty == 4,1), ys(ty == 4,2), 'ko', 'MarkerSize', 15);
